...
Editado para Arquitectura Limpia + Facturación SRI.
"""
...
try:
    ...
    # Esto previene errores oscuros en tiempo de ejecución.
    
    if not SRI_FIRMA_PASS:
        # Solo advertencia, porque a veces en CI/CD no hay pass real
